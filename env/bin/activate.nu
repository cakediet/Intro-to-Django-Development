...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/alex/Desktop/getting_started_with_django/env'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/alex/Desktop/getting_started_with_django/env/bin/deactivate.nu'
